...
class OrderFinishedControllerAdmin extends Controller
{
    ...
    function fetch()
    {
        ...
        $edit_module = $this->furl->get_module_by_name('OrderFinishedControllerAdmin');
        $main_module =  $this->furl->get_module_by_name('OrdersFinishedControllerAdmin');
