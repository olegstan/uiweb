...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/parts/breadcrumbs.css">
...
<!-- header start -->
    ...
    <?=$this->render('parts/header.php', ['search' => $search])?>
...
<div id="wrapper">
    <!-- breadcrumbs start -->
    <!--
    <?=$this->render('parts/breadcrumbs.php', ['breadcrumbs' => $breadcrumbs])?>
    -->
    <!-- breadcrumbs end -->
