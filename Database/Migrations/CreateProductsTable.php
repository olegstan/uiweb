...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Table $table) {
            ...
            $table->smallint('currency_id')->setDefault(1);
            $table->decimal('price', 10, 2)->setDefault(0);
            $table->decimal('buying_price', 10, 2)->setDefault(0);
            $table->int('brand_id')->setNullable();
