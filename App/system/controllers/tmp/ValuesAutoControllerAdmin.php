...
class ValuesAutoControllerAdmin extends Controller
{
    ...
    function fetch()
    {
        ...
        $all_tags_count = $this->tags->count_tags(array('is_auto'=>1));
        ...
        $tags_groups = $this->tags->get_taggroups(array('is_auto'=>1));
        foreach($tags_groups as &$group)
            $group->tags_count = $this->tags->count_tags(array('group_id'=>$group->id, 'is_auto'=>1));

        $this->design->assign('is_auto', 1);
