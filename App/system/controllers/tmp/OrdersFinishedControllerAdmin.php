...
class OrdersFinishedControllerAdmin extends Controller
{
    ...
    function fetch()
    {
        ...
        $orders_filter = array('status_type' => 'finished');
        $current_page = 1;
        ...
        $orders_statuses = $this->orders->get_statuses(array('status_type'=>'finished'));
        foreach($orders_statuses as &$status)
            $status->orders_count = $this->orders->count_orders(array('status_id'=>$status->id, 'status_type'=>'finished'));
        ...
        $all_orders_count = $this->orders->count_orders(array('status_type'=>'finished'));
        ...
        $this->design->assign('edit_module', $this->furl->get_module_by_name('OrderFinishedControllerAdmin'));
